...
| Terminer | Case « terminée » en un clic ; tout changement de statut propose **« Annuler »** pendant 8 s. Une tâche terminée l'est **définitivement** (l'API refuse tout autre statut, `409`) |
| Chrono | Passer une tâche **« En cours »** lance un chrono visible à la seconde sur la carte ; en sortir enregistre automatiquement le temps dans la feuille de temps (plafonné à 24 h) |
